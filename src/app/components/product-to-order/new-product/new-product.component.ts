...
export class NewProductComponent implements OnInit {
  ...
  constructor(private router: Router, private productService: ProductService,private categoryService: CategoriesService,private sizeService: SizesService, private formBuilder: FormBuilder) { }
