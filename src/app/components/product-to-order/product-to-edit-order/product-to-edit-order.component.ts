...
export class ProductToEditOrderComponent implements OnInit {
  ...
  constructor(private quantityValidatorService: QuantityValidatorService, private router: Router, private OrderProductService: OrderProductService,private orderService: OrderService,private productService: ProductService, private sizesServices: SizesService, private formBuilder: FormBuilder) { }
