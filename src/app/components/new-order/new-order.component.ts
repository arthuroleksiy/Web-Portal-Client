...
AddNewOrderForm = new FormGroup({
  ...
  totalOrderCost: new FormControl(0),
  comment: new FormControl('')
  });



  get orderDate() { return this.AddNewOrderForm.get('orderDate')}
  get customerName() { return this.AddNewOrderForm.get('customerName')}
  get statusName() { return this.AddNewOrderForm.get('statusName')}
  get totalOrderCost() { return this.AddNewOrderForm.get('totalOrderCost')}
  get comment() { return this.AddNewOrderForm.get('comment')}
